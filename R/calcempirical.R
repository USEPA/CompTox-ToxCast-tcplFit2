...
#'
#' Locate the top and the concentration at which top occurs empirically by sampling points from the experimental concentration values.
#'
...
#' ps = c(1,2,1,2,2)
#' fname = "gnls"
#' calcempirical(conc, ps, fname)
calcempirical = function(conc, ps, fname) {
