...
This vignette contains model details for all models available in `tcplfit2` package with parameter explanations and plots. Please note that all the models are implemented with the assumption that baseline is at 0. 
