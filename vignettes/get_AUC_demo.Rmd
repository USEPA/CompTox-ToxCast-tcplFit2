...
Then use another example to check what happen if a curve have areas both below and above x-axis. Here I simulated a polynomial 2 curve but please note that the parameterization of poly2 in tcplfit2 is a little different from normal poly2
