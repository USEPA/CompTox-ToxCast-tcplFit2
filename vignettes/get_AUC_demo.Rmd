...
The code chunk below calculates the AUC for exponential 3 model with the `get_AUC` function. Notice the function returns a negative AUC value, -12.92738.
...
**Figure 4:** The absolute value, 12.92738, seems to align with the area between the curve and x-axis. Note: The x-axis in this plot is in the original units, so it looks different from the curve in figure 3, which has the x-axis in $log_{10}$ units.
