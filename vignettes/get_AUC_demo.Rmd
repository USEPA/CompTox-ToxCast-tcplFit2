...
This session will examine how `get_AUC` function behave with negative curves. Taking some example data for negative curves from example 3 in the [tcplfit2 vignette](https://cran.r-project.org/web/packages/tcplfit2/vignettes/tcplfit2-vignette.html). 
