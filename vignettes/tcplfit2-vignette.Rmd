...
**Figure 3:** This figure provides several example plots generated using the `tcplfit2` plotting argument `do.plot=TRUE` in the `concRespCore` function. Each plot displays data for a single row of data in the `signatures` dataset, and like Figure 1 provides all model fits for a given response.
...
**Figure 4:** This figure provides example plots generated using the `concRespPlot` function. Each plot displays the winning curve for a single row of the `signatures` dataset, and like Figure 2 provides all the summary results for the winning model fit for a given response.
