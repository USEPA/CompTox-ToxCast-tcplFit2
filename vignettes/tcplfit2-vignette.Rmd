...
We then must remember to calculate the concentration index.  The concentration index is simply the distinct concentrations ranked from lowest to highest.  Generally this index is used to calculate the baseline median absolute deviation for an assay.
