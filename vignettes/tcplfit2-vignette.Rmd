...
```{r}
DT::datatable(res_up2[1, c("bmd", "bmdl", "bmdu")],rownames = FALSE,options = list(scrollX = T))
```
...
```{r}
DT::datatable(res_up3[1, c("bmd", "bmdl", "bmdu")],rownames = FALSE,options = list(scrollX = T))
```
